        ...
        <div className="flex flex-col gap-6 md:gap-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card border border-border p-4 md:p-6 rounded-2xl md:rounded-[2rem] shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                    <div className="flex items-center bg-secondary p-1 rounded-xl border border-border w-full sm:w-auto overflow-x-auto no-scrollbar">
                        {(['24h', '7d', '30d', '6m', 'all'] as const).map((f) => (
                            <button
                                key={f}
                                onClick={() => setTimeFilter(f)}
                                className={cn(
                                    "px-3 md:px-4 py-1.5 rounded-lg text-[10px] md:text-xs font-bold uppercase tracking-wider transition-all flex-1 sm:flex-none whitespace-nowrap",
                    ...
                    <button
                        ...
                        className="bg-emerald-600 text-white px-5 py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/10 w-full sm:w-auto shrink-0"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 space-y-4">
                    ...
                    <div className="bg-card border border-border rounded-2xl md:rounded-3xl overflow-hidden shadow-sm">
                        {stats.recent.length > 0 ? stats.recent.map((sale) => (
                            <div key={sale.id} className="px-4 md:px-6 py-4 md:py-5 flex items-center justify-between hover:bg-muted/30 transition-colors group border-b last:border-0 border-border/50">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-card border border-border rounded-2xl md:rounded-3xl p-4 md:p-6 space-y-5 shadow-sm">
    ...
    return (
        <div className="bg-card p-4 md:p-6 rounded-2xl md:rounded-[2rem] border border-border shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
            ...
            <div className="relative space-y-3 md:space-y-4">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-primary/10 text-primary flex items-center justify-center">
